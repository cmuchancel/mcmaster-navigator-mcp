...
The final exact-recovery run used 250 cases sampled across 25 catalog categories, later summarized in Table~\ref{tab:categories}. The run used \tool{gpt-5.4-mini}, page budget 8, auto-drill depth 2, maximum schema rows 700, and two internally generated search roots.
